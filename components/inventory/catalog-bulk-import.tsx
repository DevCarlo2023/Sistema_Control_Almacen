  ...
  const handleFileUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    reader.onload = async (evt) => {
      try {
        ...
        const keys = {
          codigo: findKey(['codigo / sku', 'sku', 'codigo', 'cod', 'item_code']),
          name: findKey(['nombre / identificacion', 'descripcion tecnica', 'descripcion', 'nombre', 'articulo', 'name']),
          ...
          serial: findKey(['numero de serie', 'serie', 'serial', 'n_serie', 's/n']),
